...
if (isset($_POST['tambahbarangmasuk'])) {
    ...
    $sql = "INSERT INTO barang_masuk (nama_barang, keterangan, jumlah, tanggal, pengirim, penerima) VALUES ('$nama_barang', '$keterangan', $jumlah, '$tanggal', '$pengirim', '$penerima')";
...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<a href='#' class='btn btn-danger btn-sm btn-delete ms-3'
                                                        data-bs-toggle='modal' data-bs-target='#deleteModalMasuk'
        ...
        <!--script ubah dan hapus barang masuk-->
        <script>
        // Script untuk mengisi modal edit dengan data
        document.addEventListener('DOMContentLoaded', function () {
            var editModal = document.getElementById('editModalMasuk');
            ...
            var deleteModal = document.getElementById('deleteModalMasuk');
    ...
    $(document).ready(function() {
        ...
        $('#editModalMasuk').on('show.bs.modal', function (event) {
    ...
    <!-- Modal Ubah Barang Masuk -->
    <div class="modal fade" id="editModalMasuk">
        <div class="modal-dialog">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                ...
                <form action="update_barang_masuk.php" method="post">
                    <div class="modal-body">
                        ...
                        <br>
                        <input type="number" name="jumlah" id="edit_jumlah" placeholder="Masukkan jumlah" class="form-control" required>
                        <br>
            ...
            <div class="modal-content">
                ...
                <form action="delete_barang_masuk.php" method="post">
                    <div class="modal-body">
                        ...
                        <button type="submit" class="btn btn-danger" name="delete_barang_masuk">Hapus</button>
                    </div>
                </form>
